const questionText = "¿Holis amor te gustaria ser  mi San Valentín😘? 💘";
...
yesBtn.addEventListener("click", () => {
    responseMessage.textContent = "¡Sabía que dirías que sí mi princesa pechocha 🥰! ❤️✨";
...
noBtn.addEventListener("click", () => {
    responseMessage.textContent = "¿Estás segurisima amor 🥺? 💔";
    responseMessage.style.display = "block";
});
